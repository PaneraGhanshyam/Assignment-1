...
public class PayBill extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PayBill</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            if(dao.payBill(b_id))
            {
                ErrorMessage msg=new ErrorMessage("Bill paid succesfully !","paidSuccess","alert-success");
            ...
            {
                ErrorMessage msg=new ErrorMessage("Bill paid unsuccessfull !","paidUnsuccess","alert-danger");
                HttpSession s=request.getSession();
                s.setAttribute("Message", msg);
