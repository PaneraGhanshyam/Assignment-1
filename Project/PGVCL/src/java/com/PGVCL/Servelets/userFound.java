...
public class userFound extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet userFound</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            if(f==true)
            {
                ErrorMessage msg=new ErrorMessage(request.getParameter("u_id"),"userFound","alert-success");
            ...
            {
                ErrorMessage msg=new ErrorMessage("User not found !","userNotFound","alert-danger");
                HttpSession s=request.getSession();
                s.setAttribute("Message", msg);
